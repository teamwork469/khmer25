...
<body>
    ...
    <div class="wrapper fixed__footer">
                                                ...
                                                <ul class="mega__item">
                                                    <li>
                                                        <div class="mega-item-img">
                                                            <a href="shop.html">
                                                                <img src="front/images/feature-img/3.png" alt="">
                                                            </a>
                                                        </div>
                                                    </li>
                                                </ul>
        ...
        <div class="htc__login__register bg__white ptb--130" style="background: rgba(0, 0, 0, 0) url(front/images/bg/5.jpg) no-repeat scroll center center / cover ;">
            <div class="container">
                <div class="row">
                    ...
                    <div class="footer__container clearfix">
                        ...
                        <div class="col-md-3 col-lg-3 col-sm-6">
                            <div class="ft__widget">
                                <div class="ft__logo">
                                    <a href="index.html">
                                        <img src="front/images/logo/logo.png" alt="footer logo">
                                    </a>
                                </div>
